      ...
      child: Scaffold(
        ...
        body: Container(
          ...
          child: Column(children: [
              ...
              child: Row(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: CircleAvatar(
                      radius: 30,
                      backgroundImage: widget.user.photoUrl == null ? NetworkImage("https://media.istockphoto.com/id/1337144146/vector/default-avatar-profile-icon-vector.jpg?s=612x612&w=0&k=20&c=BIbFwuv7FxTWvh5S3vB6bkT0Qv8Vn8N5Ffseq84ClGI="): NetworkImage(
            ...
            SizedBox(height: 70,),
            Text(
              "Heart Beat Data", style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold),
            ),
          Padding(
